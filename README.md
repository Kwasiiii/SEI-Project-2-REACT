...
### Styling
I chose to use Bootstrap CSS Framework for some out-the-box styling to manage my time. I needed a font that will make my web application stand out so i used Graduated for the headers and titles but for the body or contents on the page i used montserrat font family. The rest of the styling we wanted to keep quite minimal but fun to allow the user interface to be as clear and intuitive as possible. 

### Development
#### TEAM LIST PAGE
![team-list-page](https://i.imgur.com/MuFz7fm.png)
To get the team to display and its official logo I had to test the query below in insomnia to make sure it return the information i want and this returned information contained the official team logo and all i had to do was loop through it and display.
...
### Challenges
Building my first React app from scratch provided a fair amount of challenges. One of the problem as a first time react creator i was facing was information not displaying on first render but i was explained by my instructor about why is wasn't working on initial render and was fixed.

### Wins
Styling. I am not massive when it comes to styling and being introduced to bootstrap and sass i was able to incorporate them into my web application. 
Completing this project in two day solo was impressive for me as I just been introduced to React. I learnt a lot during this development.
